...
#['unc_rgb_db_0.15_n_50', 'unc_depth_db_0.15_n_50'] #['unc_depth_db_0.2_n_40' , 'unc_depth_db_0.0_n_40', 'unc_rgb_db_0.15_n_40',  'unc_rgb_db_0.0_n_40'] # 'unc_rgb_db_0.1_n_40','unc_rgb_db_0.2_n_40'
...
numbers = [6012, 5747, 230, 3869, 1647, 1075, 5304, 3250, 6415, 6762]

for number in numbers:
    file_names = [f'd/{number:06d}', f'rgb/{number:06d}']
    ...
    for img_id, img_data in data['heads'].items():
        ...
        plt.savefig(f'./obrazki/{number:06d}.png')